...
class Banana:
    ...
    def __init__(self, scene, x=0, y=0):
        self.scene = scene
        self.image = self.cargar_imagen(self.get_resource_path('assets/banana.png'), 16)
        self.image_bomb = self.cargar_imagen(self.get_resource_path('assets/bomb.png'), 8)
        ...
        self.image_array = self.cargar_imagen_como_arreglo(self.get_resource_path('assets/banana.png'))
        self.image_bomb_array = self.cargar_imagen_como_arreglo(self.get_resource_path('assets/bomb.png'))
    ...
    def get_resource_path(relative_path):
        #"""Obtiene la ruta correcta al recurso, tanto en desarrollo como en el ejecutable."""
    ...
    def cargar_imagen_como_arreglo(self, ruta):
        img = Image.open(ruta).convert("RGB")  # Nos aseguramos de que sea RGB
        return np.array(img)
